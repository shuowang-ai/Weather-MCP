...
async def get_air_quality_station_forecast(
    ...
    """Get comprehensive air quality forecast from monitoring stations with 15-day coverage including PM2.5, PM10, O3, AQI trends and health recommendations.
    
    This consolidated interface combines monitoring station data (first 5 days) with API forecasts (6-15 days) for maximum accuracy.
    
    Features:
    - 15-day air quality forecasting with multiple variables
    - Enhanced PM10 and O3 accuracy from monitoring stations
    - Trend analysis and health recommendations
    - Flexible display frequency control
